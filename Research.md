...
| `0x8a`           | PACKET_CLIENT_IDENTIFY                                   | Identify the client with a parameter DrasaOnlineClient                                         | `FUN_140c66b18(this, packet)`  | `0x8b`           | Send local config ?                                  | Send the computer specs and also the spellbar                                         | `FUN_140c66b18(this, packet)`              |
