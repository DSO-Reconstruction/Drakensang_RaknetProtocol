...
| `0x82`           | PACKET_SERVER_IDENTIFY                                   | May be DrasaOnlineLoginServer or DrasaCharacterService or DrasaOnlineMapServer      | `RakNetClient::HandleError`                      |
...
| `0x8a`           | PACKET_CLIENT_IDENTIFY                  | Identify the client with a parameter DrasaOnlineClient or ChatClient, this is Protobuf and args are passed to this packet     | `FUN_140c66b18(this, packet)`                    |
